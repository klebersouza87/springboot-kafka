package com.example.kafkaandspringboot.config;
...
public class KafkaConsumerConfig {
	...
	private ConsumerFactory<String, Greeting> greetingConsumerFactory(String groupId) {
		Map<String, Object> props = new HashMap<>();
...
//		props.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, new JsonDeserializer<>(Greeting.class));
	...
	public ConcurrentKafkaListenerContainerFactory<String, Greeting> greetingKafkaListenerContainerFactory() {
		...
		factory.setConsumerFactory(greetingConsumerFactory("greeting"));
		return factory;
	}
